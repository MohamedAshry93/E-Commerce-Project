    ...
    <div className="row gx-0 mt-5 pt-5">
      <div className="col-md-9">
        <Slider {...settings}>
          ...
          <img src={img3} alt="MainSliderImg3" className='w-100' height={400} />
        </Slider>
      </div>
      <div className="col-md-3">
        <img src={img4} alt="MainSliderImg4" className='w-100' height={200} />
        <img src={img5} alt="MainSliderImg5" className='w-100' height={200} />
      </div>
    </div>
  )
}
