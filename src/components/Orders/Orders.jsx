...
export default function Orders() {
  ...
  return (<>
    <div className="mx-auto my-5 pt-5 px-3">
      <h3>My Orders</h3>
      {userOrders.length !==0 ? (<> <div className='row border-bottom py-3 gy-4 justify-content-between align-items-center'>
        {userOrders.map((order, index) => <div key={index} className="col-md-12 py-3 my-3 shadow rounded-2">
          ...
          <div className='row'>
            {order.cartItems?.map((item) => <div key={item._id} className='col-sm-2 gy-3 gx-1 mb-3'>
              <div className='card-group h-100'>
                <div className='card'>
                  ...
                  <div className="card-body">
                    <h6 className='text-dark-emphasis fw-bold'>{item.product.title.split(' ').slice(0, 5).join(' ')}</h6>
